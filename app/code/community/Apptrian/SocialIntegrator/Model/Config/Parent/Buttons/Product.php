 ...
 */
class Apptrian_SocialIntegrator_Model_Config_Parent_Buttons_Product {
    
    protected $_options;
    const PARENT_ALERT_URLS = 'alert_urls';
    ...
    public function toOptionArray(){
        if (!$this->_options) {
        	$this->_options[] = array(
        			'value'=>self::PARENT_ALERT_URLS,
        			'label'=>Mage::helper('apptrian_socialintegrator')->__('Product Alert Urls (alert.urls)')
        	);
			$this->_options[] = array(
