 ...
 */
class Apptrian_SocialIntegrator_Model_Config_Layout_Buttons_Category {
    
    protected $_options;
	const LAYOUT_HORIZONTAL = 'category-social-buttons-horizontal-layout';
    const LAYOUT_VERTICAL   = 'category-social-buttons-vertical-layout';
